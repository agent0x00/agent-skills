...
- **[peas-framework](./skills/engineering/peas-framework/SKILL.md)** — Formal agent design using the PEAS framework (Performance, Environment, Actuators, Sensors). Walks through each element to produce a structured specification and recommended architecture.
